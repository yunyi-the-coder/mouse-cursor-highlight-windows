...
### Mouse Highlight
Highlight mouse pointer with a circle or spotlight, and when you click the mouse button it will display a ring (ripple) animation, so that your audience can follow your mouse more easily.
...
You can use your mouse pointer annotate any part of the screen. The color and pen of the annotation is customizable.